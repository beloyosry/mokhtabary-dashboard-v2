        ...
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
            <div className="flex flex-wrap justify-between items-center">
                ...
                <div className="flex justify-start items-center w-1/3">
                    ...
                    {/* Page name */}
                    <div className="hidden md:block flex-1 text-center text-primary-500 text-2xl mr-4 font-semibold">
                        {(pathname
                            ?.split("/")[1]
                            .charAt(0)
                ...
                <div className="relative flex items-center lg:order-2">
                    ...
                    {/* !TODO: Notifications Toggle Button */}
                    {/* <button
                    ...
                    {/* !TODO: Dropdown notifications */}
                    {/* {isNotificationOpen && (
                    <div className="absolute top-10 right-0 overflow-hidden z-50 my-4 w-[90vw] lg:w-[30vw] max-h-[80vh] lg:max-h-[70vh] text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 xl:rounded-xl">
                        ...
                        <div>
                            <Link
                                ...
                                <div className="flex-shrink-0">
                                    ...
                                    />
                                    <div className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-primary-600 dark:border-gray-700">
                                        <svg
                                            aria-hidden="true"
                    ...
                    {isAppsOpen && (
                        <div
                            className="absolute top-10 right-0  overflow-hidden z-50 my-4 w-[60vw] lg:w-[20vw] text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600 xl:rounded-xl"
                            id="apps-dropdown"
                        >
                            <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-600 dark:text-gray-300">
                                Apps
                    ...
                    {isProfileOpen && (
                        <div
                            className="absolute top-10 right-0 z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 xl:rounded-xl"
                            id="dropdown"
                        >
