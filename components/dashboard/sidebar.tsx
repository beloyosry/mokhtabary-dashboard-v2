        ...
        >
            ...
            <div className="flex flex-col gap-2 p-4">
                ...
                <button
                    ...
                    className="mt-auto flex w-full items-center gap-2 rounded-md px-2 py-2 text-sm font-medium text-dark-500 hover:bg-dark-50 hover:text-dark-700 dark:text-dark-200 dark:hover:bg-dark-600 dark:hover:text-dark-100"
                >
